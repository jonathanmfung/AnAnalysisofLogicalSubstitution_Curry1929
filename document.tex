...
\item Let this system be generated by operators \(W, C_1, C_2, \cdots\) Subject to the postulates
  \td{Make VII be same footnote as VI}
  \td{Ensure VI/VII footnote shows}
  \label{postulates}
  \begin{alignat*}{3}
    ...
    \textup{VI.}\quad& W \cdot W \cdot C_2 \longeq W \cdot W\footnote{VI and VII are equivalent repectively to (6) and (7) (see below). The latter may if desired replace VI and VII.} \\
    \textup{VII.}\quad& W \cdot D_j \cdot W \longeq D_{j-1} \cdot W \cdot D_3 \cdot W \cdot C_2 \: \cdot && \: C_3 \cdot C_1 \cdot C_2 \footnote{TODO: same} \qquad j \longeq 3, 4, 5 \cdots
  \end{alignat*}
  \textup{where}
  \begin{align*}
    &D_1 \longeq I \\

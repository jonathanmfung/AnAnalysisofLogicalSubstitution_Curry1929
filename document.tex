...
\item Let this system be generated by operators \(W, C_1, C_2, \cdots\) Subject to the postulates
  ...
  \begin{alignat*}{3}
    ...
    \textup{III. }& C_i \cdot C_j \longeq C_j \cdot C_i &&i \longeq 1, 2, 3, \cdots && j > i + 1 \\
    ...
    \textup{VII. }& W \cdot D_j \cdot W \longeq D_{j-1} \cdot W \cdot D_3 \cdot W \cdot C_2 \cdot C_3 \cdot C_1 \cdot C_2 \footnote{TODO: same} &&j \longeq 3, 4, 5 \cdots
  \end{alignat*}
  \textup{where}
  \begin{align*}
    &D_1 \longeq I \\

...
\item Let this system be generated by operators \(W, C_1, C_2, \cdots\) Subject to the postulates
  ...
  \label{postulates}
  \begin{alignat*}{3}
    \textup{I. }& C_i \cdot C_i \longeq I &&i \longeq 1, 2, 3, \cdots \\
    \textup{II. }& C_i \cdot C_{i+1} \cdot C_i \longeq C_{i+1} \cdot C_i \cdot C_{i+1} &&i \longeq 1, 2, 3, \cdots \\
    \textup{III. }& C_i \cdot C_j \longeq C_j \cdot C_i &&i \longeq 1, 2, 3, \cdots \quad j > i + 1 \\
    \textup{IV. }& C_i \cdot W \longeq W \cdot C_{i+1} &&i \longeq 2, 3, 4, \cdots \\
    \textup{V. }& W \cdot C_1 \longeq W \\
    \textup{VI. }& W \cdot W \cdot C_2 \longeq W \cdot W\footnote{VI and VII are equivalent repectively to (6) and (7) (see below). The latter may if desired replace VI and VII.} \\
    \textup{VII. }& W \cdot D_j \cdot W \longeq D_{j-1} \cdot W \cdot D_3 \cdot W \cdot C_2 \: \cdot && \: C_3 \cdot C_1 \cdot C_2 \footnote{TODO: same} \qquad j \longeq 3, 4, 5 \cdots
  \end{alignat*}
  \textup{where}
  \begin{align*}
    &D_1 \longeq I \\

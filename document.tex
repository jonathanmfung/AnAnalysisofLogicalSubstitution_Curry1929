...
is the analysis and criticism of thought.\footnote{Johnson, W. E., \textit{Logic}, Part I, Cambridge (1921), p. xiii.} In accordance with these defini-
...
to the same \(X\) may be proved equal by means of these postulates and \hyperref[rule:schonfinkel0]{Rules 0-3}. The sub-
...
\begin{proofnewlineindent}
  ...
  formation \(\gamma\). By \Cref{lemma:2,lemma:3} there is a uniquely determined \(\Delta_q\)
  such that
